...
function Recommend(props) {
	return (
		<Card title="推荐内容">
			...
			<RecommendItem
				recommendInfo={{ num: 1, title: '利用思否猫素材实现一个丝滑的轮播图（html + css + js）', href: 'https://segmentfault.com/a/1190000042661646' }}
			/>
			<RecommendItem
				recommendInfo={{ num: 2, title: '「🌟技术探索🌟」借助 CI / CD 实现前端应用的快速回滚', href: 'https://segmentfault.com/a/1190000042531062' }}
			/>
